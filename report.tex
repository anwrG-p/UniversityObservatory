...
\author{\IEEEauthorblockN{Mohamed Anwer Guemri, Mohamed Wali, Adem Boukhris}
\IEEEauthorblockA{\textit{2nd Year Pre-Engineering} \\
\textit{Higher Institute of Digital Engineering}\\
Tunis, Tunisia \\
}
}
